...
const MatchThreeGame: React.FC = () => {
    ...
    useEffect(() => {
        class Match3Scene extends Phaser.Scene {
            ...
            preload() {
                this.load.image("tile1", "/Game Assets/Match 3/tile1.png");
                this.load.image("tile2", "/Game Assets/Match 3/tile2.png");
                this.load.image("tile3", "/Game Assets/Match 3/tile3.png");
            }
